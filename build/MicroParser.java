...
public class MicroParser extends Parser {
	...
	public static class ProgramContext extends ParserRuleContext {
		...
		public List<TerminalNode> TEXT() { return getTokens(MicroParser.TEXT); }
		public TerminalNode TEXT(int i) {
			return getToken(MicroParser.TEXT, i);
		}
		public List<TerminalNode> COMMENT() { return getTokens(MicroParser.COMMENT); }
		public TerminalNode COMMENT(int i) {
			return getToken(MicroParser.COMMENT, i);
		}
	...
	public static final String _serializedATN =
		...
		"\2\6\n\2\f\2\16\2\t\13\2\3\2\3\2\3\2\2\2\3\2\2\3\3\2\4\5\2\f\2\7\3\2\2"+
