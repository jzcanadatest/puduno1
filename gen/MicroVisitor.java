...
public interface MicroVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link MicroParser#control_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitControl_stmt(MicroParser.Control_stmtContext ctx);
	/**
	 * Visit a parse tree produced by {@link MicroParser#loop_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLoop_stmt(MicroParser.Loop_stmtContext ctx);
	/**
